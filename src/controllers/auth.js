...
exports.addnewproduct = async (req, res) => {
  const { name, description, brand, price, image, priority, category_id } =
    req.body;
  try {
    await db.query(
      "insert into products (name, description, brand, price, image, priority, category_id) values ($1, $2, $3, $4, $5, $6, $7)",
      [name, description, brand, price, image, priority, category_id]
    );
    return res.status(201).json({
      success: true,
